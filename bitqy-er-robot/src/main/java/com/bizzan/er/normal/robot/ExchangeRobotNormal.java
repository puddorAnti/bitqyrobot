...
import com.bizzan.er.normal.config.EnvConfig;
...
public class ExchangeRobotNormal implements Runnable, ExchangeRobot {
    ...
    protected int uid = 1;
    protected String sign = "987654321asdf";
    protected String currenOrderURL = "http://" + EnvConfig.DOMAIN + "/exchange/order/mockcurrentydhdnskd";
    protected String cancelOrderURL = "http://" + EnvConfig.DOMAIN + "/exchange/order/mockcancelydhdnskd";
    protected String exchangeTYPE = "LIMIT_PRICE";
    protected String directionSELL = "SELL";
    protected String commitOrderURL = "http://" + EnvConfig.DOMAIN + "/exchange/order/mockaddydhdnskd";
    protected String plateURL = "http://" + EnvConfig.DOMAIN + "/market/exchange-plate-mini";
    ...
    protected String sendOrder(ExchangeOrderBean order) {
        ...
        try {
            ...
            logger.error("url="+this.commitOrderURL+"，"+param);
            e.printStackTrace();
        }
        return null;
    }
